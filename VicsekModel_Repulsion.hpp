...
namespace VicsekModel_2D{
  ...
  void Evolve_VicsekModel_Repulsion(vector<Particle>& PG,
  ...
  void Evolve_VicsekModel_Repulsion_MP(vector<Particle>& PG,
				       vector<vector<int>>& MeshedIndexMat,
...
#pragma omp parallel for
  ...
  PolarParticle2D_GT Evolve_VicsekModel_Repulsion_Periodic(const PolarParticle2D_GT& PG,
  ...
  {//an integrated version of Evolve_VicsekModel, evolving for StepNumber steps
    ...
    for( int i_Step=0 ; i_Step<StepNumber ; i_Step++ )
      Evolve_VicsekModel_Repulsion(vP,MeshedIndex,LDAdjBox,Parameters,Distance_,i_MP);
...
#ifndef LocalProgram
  PolarParticle2D_GT Evolve_VicsekModel_Repulsion_Periodic_MP(const PolarParticle2D_GT& PG,
							      const BoxInfoT& BoxInfo,
							      const vector<double>& Parameters,
							      const int& StepNumber)
  {//an integrated version of Evolve_VicsekModel, evolving for StepNumber steps
    ...
    for( int i_Step=0 ; i_Step<StepNumber ; i_Step++ )
      Evolve_VicsekModel_Repulsion_MP(vP,MeshedIndex,AllAdjBox,Parameters,Distance_);
